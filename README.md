...
這個資料夾已經 `git init` 好了。接下來到 GitHub 建立一個新的 repository（public 或 private 都可以，
若是 private 要用 GitHub Pages 需要付費方案，建議用 public），然後：
...
4. 存檔後幾分鐘內會產生網址，例如 `https://<你的帳號>.github.io/<repo名稱>/`
   - 小孩用：`.../index.html`
   - 媽媽後台：`.../admin.html`
